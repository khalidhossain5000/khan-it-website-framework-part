      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-15">
        ...
        <div className="flex-6">
          ...
          <p className="text-center lg:text-left text-lg font-regular text-[#65758B]">
            Founded in 2017 by Md Faruk Khan, Khan IT began with a single
            purpose to help businesses in Bangladesh and beyond achieve
            measurable growth through ethical, data-driven, and Al-powered
            digital marketing.
          </p>
          ...
          <div className="achivment flex items-center gap-6 flex-wrap mt-10">
            ...
            <p className="bg-[#FFFBF0] py-2 px-4 rounded-4xl text-text-primary text-[16px] font-medium  flex items-center gap-2">
              <span className="flex items-center gap-1 text-xl text-[#E89F02E8]">
                <FaStar className="text-[#E89F02E8] text-xl" />
                4.9/5
              </span>
              On Clutch
            </p>
        ...
        <div className="flex-5">
          {infoData.map((data, i) => (
            <InfoCard key={i} data={data}></InfoCard>
          ))}
        </div>
      </div>
    </section>
