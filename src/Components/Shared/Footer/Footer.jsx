        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="space-y-4 xl:col-span-2">
            ...
            <p className="text-white text-[16px] mt-6 mb-10 max-w-md mx-auto md:mx-0 text-center lg:text-left">
              Khan IT is a full-stack digital marketing agency in Bangladesh
              offering complete online marketing, web design, and branding
              solutions.
            </p>
          ...
          <div className="text-center lg:text-left">
            ...
            <ul className="text-[#ffffff80] text-sm space-y-2 mb-6">
              ...
              <li className="flex items-center justify-center lg:justify-start gap-5">
                <FiPhone size={30} />{" "}
                <span className="text-white font-medium">+8801404992727</span>
              </li>
              <li className="flex items-center justify-center lg:justify-start gap-5">
